...
public class Utility {
    ...
    public void highlightElement(WebElement element, String borderColor, String textColor) {
        if (driver == null) {
    ...
    public List<List<String>> printTableContents(By tableLocator, boolean printTable) {
        if (driver == null) {
            throw new IllegalStateException("WebDriver is not initialized.");
        }
    ...
    public boolean isValueListedInTable(By tableLocator, String value) {
        if (driver == null) {
            throw new IllegalStateException("WebDriver is not initialized.");
        }
